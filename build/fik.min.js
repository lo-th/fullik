...
getBaseLocation:function(){return this.bones[0].getStartLocation()},getEffectorLocation:function(){return this.bones[this.numBones-1].getEndLocation()},getLastTargetLocation:function(){return this.lastTargetLocation},getLiveChainLength:function(){for(var a=0,b=this.numBones;b--;)a+=this.bones[b].getLength();return a},getBaseboneRelativeReferenceConstraintUV:function(){return this.baseboneRelativeReferenceConstraintUV},setConnectedBoneNumber:function(a){this.connectedBoneNumber=a},setConnectedChainNumber:function(a){this.connectedChainNumber=
a},setBoneConnectionPoint:function(a){this.boneConnectionPoint=a},setColor:function(a){this.color=a;for(a=this.numBones;a--;)this.bones[a].setColor(this.color)},setBaseboneRelativeConstraintUV:function(a){this.baseboneRelativeConstraintUV=a.normalised()},setBaseboneRelativeReferenceConstraintUV:function(a){this.baseboneRelativeReferenceConstraintUV=a.normalised()},setBaseboneConstraintUV:function(a){this.baseboneConstraintUV=a.normalised()},setRotorBaseboneConstraint:function(a,b,c){0===this.numBones?
r.error("Chain must contain a basebone before we can specify the basebone constraint type."):0<b.length()?(this.baseboneConstraintType="global"===(a||"global")?2:4,this.baseboneConstraintUV=b.normalised(),this.baseboneRelativeConstraintUV.copy(this.baseboneConstraintUV),this.bones[0].joint.setAsBallJoint(c)):r.error("Constraint axis cannot be zero.")},setHingeBaseboneConstraint:function(a,b,c,d,e){0===this.numBones?r.error("Chain must contain a basebone before we can specify the basebone constraint type."):
0>=b.length()?r.error("Hinge rotation axis cannot be zero."):0>=e.length()?r.error("Hinge reference axis cannot be zero."):p.perpendicular(b,e)?(a=a||"global",this.baseboneConstraintType="global"===a?3:5,this.baseboneConstraintUV=b.normalised(),this.bones[0].joint.setHinge("global"===a?12:11,b,c,d,e)):r.error("The hinge reference axis must be in the plane of the hinge rotation axis, that is, they must be perpendicular.")},setFreelyRotatingGlobalHingedBasebone:function(a){this.setHingeBaseboneConstraint("global",
...
e)))},getBoneConnectionPoint:function(){return this.boneConnectionPoint},getConnectedBoneNumber:function(){return this.connectedBoneNumber},getConnectedChainNumber:function(){return this.connectedChainNumber},getEmbeddedTarget:function(){return this.embeddedTarget},getBaseboneConstraintType:function(){return this.baseboneConstraintType},getBaseboneConstraintUV:function(){if(1!==this.baseboneConstraintType)return this.baseboneConstraintUV},getBaseLocation:function(){return this.bones[0].getStartLocation()},
getEffectorLocation:function(){return this.bones[this.numBones-1].getEndLocation()},getLastTargetLocation:function(){return this.lastTargetLocation},getLiveChainLength:function(){for(var a=0,b=this.numBones;b--;)a+=this.bones[b].getLength();return a},setColor:function(a){this.color=a;for(a=this.numBones;a--;)this.bones[a].setColor(this.color)},setBaseboneRelativeConstraintUV:function(a){this.baseboneRelativeConstraintUV=a},setConnectedBoneNumber:function(a){this.connectedBoneNumber=a},setConnectedChainNumber:function(a){this.connectedChainNumber=
a},setBoneConnectionPoint:function(a){this.boneConnectionPoint=a},setBaseboneConstraintUV:function(a){p.validateDirectionUV(a);this.baseboneConstraintUV.copy(a.normalised())},setBaseLocation:function(a){this.baseLocation.copy(a)},setBaseboneConstraintType:function(a){this.baseboneConstraintType=a},setFixedBaseMode:function(a){if(a||-1===this.connectedChainNumber)if(6!==this.baseboneConstraintType||a)this.fixedBaseMode=a},setMaxIterationAttempts:function(a){1>a||(this.maxIteration=a)},setMinIterationChange:function(a){0>
a||(this.minIterationChange=a)},setSolveDistanceThreshold:function(a){0>a||(this.solveDistanceThreshold=a)},solveForEmbeddedTarget:function(){if(this.useEmbeddedTarget)return this.solveForTarget(this.embeddedTarget)},resetTarget:function(){this.lastBaseLocation=new n(Infinity,Infinity);this.currentSolveDistance=Infinity},solveForTarget:function(a){this.tmpTarget.set(a.x,a.y);var b=this.precision;if(this.lastTargetLocation.approximatelyEquals(this.tmpTarget,b)&&this.lastBaseLocation.approximatelyEquals(this.baseLocation,
b))return this.currentSolveDistance;a=null;this.lastBaseLocation.approximatelyEquals(this.baseLocation,b)?(b=this.bones[this.numBones-1].end.distanceTo(this.tmpTarget),a=this.cloneBones()):b=Infinity;for(var c=[],d=Infinity,e=Infinity,f,g=this.maxIteration;g--;){f=this.solveIK(this.tmpTarget);if(f<d){if(d=f,c=this.cloneBones(),f<=this.solveDistanceThreshold)break}else if(Math.abs(f-e)<this.minIterationChange)break;e=f}d<b?(this.currentSolveDistance=d,this.bones=c):(this.currentSolveDistance=b,this.bones=
a);this.lastBaseLocation.copy(this.baseLocation);this.lastTargetLocation.copy(this.tmpTarget);return this.currentSolveDistance},solveIK:function(a){if(0!==this.numBones){for(var b,c,d,e,f,g=this.numBones;g--;)b=this.bones[g],c=b.length,g!==this.numBones-1?(d=this.bones[g+1],e=b.getDirectionUV().negate(),f=11===b.joint.coordinateSystem?d.getDirectionUV().negate():b.getGlobalConstraintUV().negated(),e.constrainedUV(f,d.joint.min,d.joint.max)):(b.setEndLocation(a),e=b.getDirectionUV().negate(),0<g?(f=
11===b.joint.coordinateSystem?this.bones[g-1].getDirectionUV().negate():b.getGlobalConstraintUV().negated(),e.constrainedUV(f,b.joint.min,b.joint.max)):11!==b.joint.coordinateSystem&&(f=b.getGlobalConstraintUV().negated(),e.constrainedUV(f,b.joint.min,b.joint.max))),d=b.getEndLocation().plus(e.times(c)),b.setStartLocation(d),0<g&&this.bones[g-1].setEndLocation(d);for(g=0;g<this.numBones;g++)b=this.bones[g],c=b.length,0!==g?(e=b.getDirectionUV(),f=11===b.joint.coordinateSystem?this.bones[g-1].getDirectionUV():
b.getGlobalConstraintUV(),e.constrainedUV(f,b.joint.min,b.joint.max),c=b.getStartLocation().plus(e.times(c)),b.setEndLocation(c),g<this.numBones-1&&this.bones[g+1].setStartLocation(c)):(this.fixedBaseMode?b.setStartLocation(this.baseLocation):(d=b.getEndLocation().minus(b.getDirectionUV().times(c)),b.setStartLocation(d)),e=b.getDirectionUV(),1===this.baseboneConstraintType?(c=b.getStartLocation().plus(e.times(c)),b.setEndLocation(c),1<this.numBones&&this.bones[1].setStartLocation(c)):(f=8===this.baseboneConstraintType?
this.baseboneRelativeConstraintUV:this.baseboneConstraintUV,e.constrainedUV(f,b.joint.min,b.joint.max),c=b.getStartLocation().plus(e.times(c)),b.setEndLocation(c),g<this.numBones-1&&this.bones[g+1].setStartLocation(c)));this.lastTargetLocation.copy(a);return this.bones[this.numBones-1].end.distanceTo(a)}},updateChainLength:function(){this.chainLength=0;for(var a=this.numBones;a--;)this.chainLength+=this.bones[a].length},cloneBones:function(){for(var a=[],b=0,c=this.bones.length;b<c;b++)a.push(this.bones[b].clone());
