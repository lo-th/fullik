...
new v;a.type=this.type;a.rotor=this.rotor;a.max=this.max;a.min=this.min;a.rotationAxisUV.copy(this.rotationAxisUV);a.referenceAxisUV.copy(this.referenceAxisUV);return a},testAngle:function(){this.freeHinge=!0},validateAngle:function(a){a=0>a?0:a;return 180<a?180:a},setAsBallJoint:function(a){this.rotor=this.validateAngle(a)*q;this.type=10},setHinge:function(a,b,c,d,e){this.type=a;this.min=-(this.validateAngle(c)*q);this.max=this.validateAngle(d)*q;this.testAngle();this.rotationAxisUV.copy(b.normalised());
this.referenceAxisUV.copy(e.normalised())},getJointType:function(){return this.type},getHingeReferenceAxis:function(){return this.referenceAxisUV},getHingeRotationAxis:function(){return this.rotationAxisUV},setBallJointConstraintDegs:function(a){this.rotor=this.validateAngle(a)*q},setHingeJointClockwiseConstraintDegs:function(a){this.min=-(this.validateAngle(a)*q);this.testAngle()},setHingeJointAnticlockwiseConstraintDegs:function(a){this.max=this.validateAngle(a)*q;this.testAngle()},setHingeRotationAxis:function(a){this.rotationAxisUV.copy(a).normalize()},
setHingeReferenceAxis:function(a){this.referenceAxisUV.copy(a).normalize()}});Object.assign(u.prototype,{isBone3D:!0,init:function(a,b,c,d){this.setStartLocation(a);b?(this.setEndLocation(b),this.length=this.getLength()):(this.setLength(d),this.setEndLocation(this.start.plus(c.normalised().times(d))))},clone:function(){var a=new u(this.start,this.end);a.joint=this.joint.clone();return a},setColor:function(a){this.color=a},setBoneConnectionPoint:function(a){this.boneConnectionPoint=a},setHingeJointClockwiseConstraintDegs:function(a){this.joint.setHingeJointClockwiseConstraintDegs(a)},
setHingeJointAnticlockwiseConstraintDegs:function(a){this.joint.setHingeJointAnticlockwiseConstraintDegs(a)},setBallJointConstraintDegs:function(a){this.joint.setBallJointConstraintDegs(a)},setStartLocation:function(a){this.start.copy(a)},setEndLocation:function(a){this.end.copy(a)},setLength:function(a){0<a&&(this.length=a)},setJoint:function(a){this.joint=a},getBoneConnectionPoint:function(){return this.boneConnectionPoint},getDirectionUV:function(){return this.end.minus(this.start).normalize()},
getStartLocation:function(){return this.start},getEndLocation:function(){return this.end},getJointType:function(){return this.joint.getJointType()},getLength:function(){return this.start.distanceTo(this.end)}});Object.assign(z.prototype,{isChain3D:!0,clone:function(){var a=new z;a.solveDistanceThreshold=this.solveDistanceThreshold;a.minIterationChange=this.minIterationChange;a.maxIteration=this.maxIteration;a.precision=this.precision;a.bones=this.cloneBones();a.baseLocation.copy(this.baseLocation);
...
-1===b&&this.chains[a].setFixedBaseMode(this.fixedBaseMode)},getNumChains:function(){return this.numChains},getChain:function(a){return this.chains[a]},connectChain:function(a,b,c,d,e,f,g){if(!(b>this.numChains||c>this.chains[b].numBones)){a=a.clone();void 0!==g&&a.setColor(g);a.setBoneConnectionPoint("end"===d?21:20);a.setConnectedChainNumber(b);a.setConnectedBoneNumber(c);b="end"===d?this.chains[b].bones[c].end:this.chains[b].bones[c].start;a.setBaseLocation(b);a.setFixedBaseMode(!0);for(c=0;c<
...
wireframe:!1,shadowSide:!1}),l=new THREE.MeshBasicMaterial({wireframe:!0}),k=null;e=a.joint.type;switch(e){case 10:l.color.setHex(16737792);if(a.joint.rotor===Math.PI)break;a=new THREE.CylinderBufferGeometry(0,2,2,6,1,!0);a.applyMatrix((new THREE.Matrix4).makeRotationX(.5*-Math.PI));a.applyMatrix((new THREE.Matrix4).makeTranslation(0,0,1));k=new THREE.Mesh(a,l);break;case 12:f=a.joint.getHingeRotationAxis();var m=a.joint.min;a=a.joint.max;k=2;l.color.setHex(16776960);a=new THREE.CircleBufferGeometry(k,
12,m,-m+a);1===f.z&&a.applyMatrix((new THREE.Matrix4).makeRotationX(.5*-Math.PI));1===f.y&&(a.applyMatrix((new THREE.Matrix4).makeRotationY(.5*-Math.PI)),a.applyMatrix((new THREE.Matrix4).makeRotationX(.5*-Math.PI)));1===f.x&&a.applyMatrix((new THREE.Matrix4).makeRotationY(.5*Math.PI));k=new THREE.Mesh(a,l);break;case 11:f=a.joint.getHingeRotationAxis(),k=2,m=a.joint.min,a=a.joint.max,l.color.setHex(65535),a=new THREE.CircleBufferGeometry(k,12,m,-m+a),a.applyMatrix((new THREE.Matrix4).makeRotationX(.5*
-Math.PI)),1===f.z&&(a.applyMatrix((new THREE.Matrix4).makeRotationY(.5*-Math.PI)),a.applyMatrix((new THREE.Matrix4).makeRotationX(.5*Math.PI))),1===f.x&&a.applyMatrix((new THREE.Matrix4).makeRotationZ(.5*-Math.PI)),1===f.y&&(a.applyMatrix((new THREE.Matrix4).makeRotationX(.5*Math.PI)),a.applyMatrix((new THREE.Matrix4).makeRotationY(.5*Math.PI))),k=new THREE.Mesh(a,l)}f=new THREE.AxesHelper(1.5);g=new THREE.Mesh(g,h);g.add(f);this.scene.add(g);g.castShadow=!0;g.receiveShadow=!0;-1!==b?null!==k&&(12!==
e?(k.position.z=d.bones[b].length,c[b].add(k)):g.add(k)):null!==k&&g.add(k);return g},clearAllBoneMesh:function(){if(this.isWithMesh){var a,b;for(a=this.meshChains.length;a--;){for(b=this.meshChains[a].length;b--;){var c=this.meshChains[a][b];this.scene.remove(c);c.geometry.dispose();c.material.dispose()}this.meshChains[a]=[]}this.meshChains=[]}}});Object.assign(w.prototype,{isJoint2D:!0,clone:function(){var a=new w;a.coordinateSystem=this.coordinateSystem;a.max=this.max;a.min=this.min;return a},
validateAngle:function(a){a=0>a?0:a;return 180<a?180:a},set:function(a){this.max=a.max;this.min=a.min;this.coordinateSystem=a.coordinateSystem},setClockwiseConstraintDegs:function(a){this.min=-(this.validateAngle(a)*q)},setAnticlockwiseConstraintDegs:function(a){this.max=this.validateAngle(a)*q},setConstraintCoordinateSystem:function(a){this.coordinateSystem=a},getConstraintCoordinateSystem:function(){return this.coordinateSystem}});Object.assign(x.prototype,{isBone2D:!0,clone:function(){var a=new x(this.start,
...
getLength:function(){return this.start.distanceTo(this.end)},getStartLocation:function(){return this.start},getEndLocation:function(){return this.end}});Object.assign(A.prototype,{isChain2D:!0,clone:function(){var a=new A;a.solveDistanceThreshold=this.solveDistanceThreshold;a.minIterationChange=this.minIterationChange;a.maxIteration=this.maxIteration;a.precision=this.precision;a.bones=this.cloneBones();a.baseLocation.copy(this.baseLocation);a.lastTargetLocation.copy(this.lastTargetLocation);a.lastBaseLocation.copy(this.lastBaseLocation);
...
this.color;a.embeddedTarget=this.embeddedTarget.clone();a.useEmbeddedTarget=this.useEmbeddedTarget;return a},clear:function(){for(var a=this.numBones;a--;)this.removeBone(a)},addBone:function(a){null===a.color&&a.setColor(this.color);this.bones.push(a);0===this.numBones&&(this.baseLocation.copy(a.getStartLocation()),this.baseboneConstraintUV.copy(a.getDirectionUV()));this.numBones++;this.updateChainLength()},removeBone:function(a){a<this.numBones&&(this.bones.splice(a,1),this.numBones--,this.updateChainLength())},
addConsecutiveBone:function(a,b,c,d,e){if(0===this.numBones)r.error("Chain is empty ! need first bone");else if(a.isBone2D){b=a.getDirectionUV();p.validateDirectionUV(b);c=a.length;p.validateLength(c);var f=this.bones[this.numBones-1].getEndLocation();a.setStartLocation(f);a.setEndLocation(f.plus(b.times(c)));this.addBone(a)}else a.isVector2&&(e=e||this.color,p.validateDirectionUV(a),p.validateLength(b),f=this.bones[this.numBones-1].getEndLocation(),this.addBone(new x(f,null,a.normalised(),b,c,d,
...
getChainLength:function(){return this.chainLength},getConnectedBoneNumber:function(){return this.connectedBoneNumber},getConnectedChainNumber:function(){return this.connectedChainNumber},getEffectorLocation:function(){return this.bones[this.numBones-1].getEndLocation()},getLastTargetLocation:function(){return this.lastTargetLocation},getLiveChainLength:function(){for(var a=0,b=this.numBones;b--;)a+=this.bones[b].getLength();return a},getNumBones:function(){return this.numBones},setColor:function(a){this.color=
a;for(a=this.numBones;a--;)this.bones[a].setColor(this.color)},setBaseboneRelativeConstraintUV:function(a){this.baseboneRelativeConstraintUV=a},setConnectedBoneNumber:function(a){this.connectedBoneNumber=a},setConnectedChainNumber:function(a){this.connectedChainNumber=a},setBoneConnectionPoint:function(a){this.boneConnectionPoint=a},setBaseboneConstraintUV:function(a){p.validateDirectionUV(a);this.baseboneConstraintUV.copy(a.normalised())},setBaseLocation:function(a){this.baseLocation.copy(a)},setBaseboneConstraintType:function(a){this.baseboneConstraintType=
a},setFixedBaseMode:function(a){if(a||-1===this.connectedChainNumber)if(6!==this.baseboneConstraintType||a)this.fixedBaseMode=a},setMaxIterationAttempts:function(a){1>a||(this.maxIteration=a)},setMinIterationChange:function(a){0>a||(this.minIterationChange=a)},setSolveDistanceThreshold:function(a){0>a||(this.solveDistanceThreshold=a)},solveForEmbeddedTarget:function(){if(this.useEmbeddedTarget)return this.solveForTarget(this.embeddedTarget)},resetTarget:function(){this.lastBaseLocation=new n(Infinity,
Infinity);this.currentSolveDistance=Infinity},solveForTarget:function(a){this.tmpTarget.set(a.x,a.y);var b=this.precision;if(this.lastTargetLocation.approximatelyEquals(this.tmpTarget,b)&&this.lastBaseLocation.approximatelyEquals(this.baseLocation,b))return this.currentSolveDistance;a=null;this.lastBaseLocation.approximatelyEquals(this.baseLocation,b)?(b=p.distanceBetween(this.bones[this.numBones-1].getEndLocation(),this.tmpTarget),a=this.cloneBones()):b=Infinity;for(var c=[],d=Infinity,e=Infinity,
f,g=this.maxIteration;g--;){f=this.solveIK(this.tmpTarget);if(f<d){if(d=f,c=this.cloneBones(),f<=this.solveDistanceThreshold)break}else if(Math.abs(f-e)<this.minIterationChange)break;e=f}d<b?(this.currentSolveDistance=d,this.bones=c):(this.currentSolveDistance=b,this.bones=a);this.lastBaseLocation.copy(this.baseLocation);this.lastTargetLocation.copy(this.tmpTarget);return this.currentSolveDistance},solveIK:function(a){if(0!==this.numBones){for(var b,c,d,e,f,g=this.numBones;g--;)b=this.bones[g],c=
b.length,g!==this.numBones-1?(d=this.bones[g+1],e=b.getDirectionUV().negate(),f=11===b.joint.coordinateSystem?d.getDirectionUV().negate():b.getGlobalConstraintUV().negated(),e.constrainedUV(f,d.joint.min,d.joint.max)):(b.setEndLocation(a),e=b.getDirectionUV().negate(),0<g?(f=11===b.joint.coordinateSystem?this.bones[g-1].getDirectionUV().negate():b.getGlobalConstraintUV().negated(),e.constrainedUV(f,b.joint.min,b.joint.max)):11!==b.joint.coordinateSystem&&(f=b.getGlobalConstraintUV().negated(),e.constrainedUV(f,
b.joint.min,b.joint.max))),d=b.getEndLocation().plus(e.times(c)),b.setStartLocation(d),0<g&&this.bones[g-1].setEndLocation(d);for(g=0;g<this.numBones;g++)b=this.bones[g],c=b.length,0!==g?(e=b.getDirectionUV(),f=11===b.joint.coordinateSystem?this.bones[g-1].getDirectionUV():b.getGlobalConstraintUV(),e.constrainedUV(f,b.joint.min,b.joint.max),c=b.getStartLocation().plus(e.times(c)),b.setEndLocation(c),g<this.numBones-1&&this.bones[g+1].setStartLocation(c)):(this.fixedBaseMode?b.setStartLocation(this.baseLocation):
(d=b.getEndLocation().minus(b.getDirectionUV().times(c)),b.setStartLocation(d)),e=b.getDirectionUV(),1===this.baseboneConstraintType?(c=b.getStartLocation().plus(e.times(c)),b.setEndLocation(c),1<this.numBones&&this.bones[1].setStartLocation(c)):(f=8===this.baseboneConstraintType?this.baseboneRelativeConstraintUV:this.baseboneConstraintUV,e.constrainedUV(f,b.joint.min,b.joint.max),c=b.getStartLocation().plus(e.times(c)),b.setEndLocation(c),g<this.numBones-1&&this.bones[g+1].setStartLocation(c)));
this.lastTargetLocation.copy(a);b=this.bones[this.numBones-1].getEndLocation();return p.distanceBetween(b,a)}},updateChainLength:function(){this.chainLength=0;for(var a=this.numBones;a--;)this.chainLength+=this.bones[a].length},cloneBones:function(){for(var a=[],b=0,c=this.bones.length;b<c;b++)a.push(this.bones[b].clone());return a}});Object.assign(C.prototype,{isStructure2D:!0,update:function(){for(var a,b,c,d=new THREE.Vector3,e,f=0;f<this.numChains;f++)if(a=this.chains[f],b=this.targets[f],e=a.getConnectedChainNumber(),
c=a.getBaseboneConstraintType(),-1!==e&&6!==c&&(e=this.chains[e].getBone(a.getConnectedBoneNumber()),a.setBaseLocation(20===a.getBoneConnectionPoint()?e.getStartLocation():e.getEndLocation()),e=e.getDirectionUV(),7===c?a.setBaseboneConstraintUV(e):8===c&&(c=E.getSignedAngle(e),c=a.getBaseboneConstraintUV().rotate(c),a.setBaseboneRelativeConstraintUV(c))),a.useEmbeddedTarget?a.solveForEmbeddedTarget():a.solveForTarget(b),this.isWithMesh)for(b=this.meshChains[f],e=0;e<a.numBones;e++)c=a.getBone(e),
b[e].position.set(c.start.x,c.start.y,0),b[e].lookAt(d.set(c.end.x,c.end.y,0))},setFixedBaseMode:function(a){this.fixedBaseMode=a;a=this.numChains;for(var b;a--;)b=this.chains[a].getConnectedChainNumber(),-1===b&&this.chains[a].setFixedBaseMode(this.fixedBaseMode)},clear:function(){this.clearAllBoneMesh();var a;for(a=this.numChains;a--;)this.remove(a);this.chains=[];this.meshChains=[];this.targets=[]},add:function(a,b,c){this.chains.push(a);this.targets.push(b);this.numChains++;c&&this.addChainMeshs(a)},
remove:function(a){this.chains[a].clear();this.chains.splice(a,1);this.meshChains.splice(a,1);this.targets.splice(a,1);this.numChains--},getNumChains:function(){return this.numChains},getChain:function(a){return this.chains[a]},connectChain:function(a,b,c,d,e,f,g){d=d||"end";if(b>this.numChains)r.error("Chain not existe !");else if(c>this.chains[b].numBones)r.error("Bone not existe !");else{a=a.clone();a.setBoneConnectionPoint("end"===d?21:20);a.setConnectedChainNumber(b);a.setConnectedBoneNumber(c);
b="end"===d?this.chains[b].bones[c].end:this.chains[b].bones[c].start;a.setBaseLocation(b);a.setFixedBaseMode(!0);for(c=0;c<a.numBones;c++)a.bones[c].start.add(b),a.bones[c].end.add(b);this.add(a,e,f)}},addChainMeshs:function(a,b){this.isWithMesh=!0;b=[];for(var c=a.bones.length,d=0;d<c;d++)b.push(this.addBoneMesh(a.bones[d]));this.meshChains.push(b)},addBoneMesh:function(a){var b=a.length,c=a.color;a=new THREE.CylinderBufferGeometry(1,.5,b,4);a.applyMatrix((new THREE.Matrix4).makeRotationX(-p.pi90));
a.applyMatrix((new THREE.Matrix4).makeTranslation(0,0,.5*b));b=new THREE.MeshStandardMaterial({color:c,wireframe:!1,shadowSide:!1});new THREE.MeshBasicMaterial({wireframe:!0});b=new THREE.Mesh(a,b);b.castShadow=!0;b.receiveShadow=!0;this.scene.add(b);return b},clearAllBoneMesh:function(){if(this.isWithMesh){var a,b;for(a=this.meshChains.length;a--;){for(b=this.meshChains[a].length;b--;){var c=this.meshChains[a][b];this.scene.remove(c);c.geometry.dispose();c.material.dispose()}this.meshChains[a]=[]}this.meshChains=
[]}}});Object.assign(D.prototype,{isIKSolver:!0});h._Math=p;h.V2=n;h.V3=m;h.M3=y;h.Joint3D=v;h.Bone3D=u;h.Chain3D=z;h.Structure3D=B;h.Joint2D=w;h.Bone2D=x;h.Chain2D=A;h.Structure2D=C;h.IKSolver=D;h.REVISION="1.3.3";h.MIN_DEGS=0;h.MAX_DEGS=180;h.MAX_RAD=t;h.PRECISION=.001;h.PRECISION_DEG=.01;h.MAX_VALUE=Infinity;h.TORAD=q;h.TODEG=F;h.NONE=1;h.GLOBAL_ROTOR=2;h.GLOBAL_HINGE=3;h.LOCAL_ROTOR=4;h.LOCAL_HINGE=5;h.GLOBAL_ABSOLUTE=6;h.LOCAL_RELATIVE=7;h.LOCAL_ABSOLUTE=8;h.J_BALL=10;h.J_LOCAL=11;h.J_GLOBAL=
12;h.START=20;h.END=21;h.X_AXE=G;h.Y_AXE=H;h.Z_AXE=I;h.X_NEG=J;h.Y_NEG=K;h.Z_NEG=L;h.UP=E;h.DOWN=M;h.LEFT=N;h.RIGHT=O;Object.defineProperty(h,"__esModule",{value:!0})});
