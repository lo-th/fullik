...
d.joint.min,d.joint.max)):(b.setEndLocation(a),e=b.getDirectionUV().negate(),0<h?(f=11===b.joint.coordinateSystem?this.bones[h-1].getDirectionUV().negate():b.getGlobalConstraintUV().negated(),e.constrainedUV(f,b.joint.min,b.joint.max)):11!==b.joint.coordinateSystem&&(f=b.getGlobalConstraintUV().negate(),e.constrainedUV(f,b.joint.min,b.joint.max))),d=b.getEndLocation().plus(e.times(c)),b.setStartLocation(d),0<h&&this.bones[h-1].setEndLocation(d);for(h=0;h<this.numBones;h++)b=this.bones[h],c=b.length,
0!==h?(e=b.getDirectionUV(),f=11===b.joint.coordinateSystem?this.bones[h-1].getDirectionUV():b.getGlobalConstraintUV(),e.constrainedUV(f,b.joint.min,b.joint.max),c=b.getStartLocation().plus(e.times(c)),b.setEndLocation(c),h<this.numBones-1&&this.bones[h+1].setStartLocation(c)):(this.fixedBaseMode?b.setStartLocation(this.baseLocation):(d=b.getEndLocation().minus(b.getDirectionUV().times(c)),b.setStartLocation(d)),e=b.getDirectionUV(),1===this.baseboneConstraintType?(c=b.getStartLocation().plus(e.times(c)),
b.setEndLocation(c),1<this.numBones&&this.bones[1].setStartLocation(c)):(f=8===this.baseboneConstraintType?this.baseboneRelativeConstraintUV:this.baseboneConstraintUV,e.constrainedUV(f,b.joint.min,b.joint.max),c=b.getStartLocation().plus(e.times(c)),b.setEndLocation(c),h<this.numBones-1&&this.bones[h+1].setStartLocation(c)));this.lastTargetLocation.copy(a);b=this.bones[this.numBones-1].getEndLocation();return g.distanceBetween(b,a)}},updateChainLength:function(){this.bonesLength=0;for(var a=this.numBones;a--;)this.bonesLength+=
this.bones[a].length},cloneBones:function(){for(var a=[],b=0,c=this.bones.length;b<c;b++)a.push(this.bones[b].clone());return a}});Object.assign(A.prototype,{isStructure2D:!0,update:function(){for(var a,b,c,d=new THREE.Vector3,e,f=0;f<this.numChains;f++)if(a=this.chains[f],b=this.targets[f],e=a.getConnectedChainNumber(),c=a.getBaseboneConstraintType(),-1!==e&&6!==c&&(e=this.chains[e].getBone(a.getConnectedBoneNumber()),20===a.getBoneConnectionPoint()?a.setBaseLocation(e.getStartLocation()):a.setBaseLocation(e.getEndLocation()),
e=e.getDirectionUV(),7===c?a.setBaseboneConstraintUV(e):8===c&&(c=C.getSignedAngle(e),c=a.getBaseboneConstraintUV().rotate(c),a.setBaseboneRelativeConstraintUV(c))),a.useEmbeddedTarget?a.solveForEmbeddedTarget():a.updateTarget(b),this.isWithMesh)for(b=this.meshChains[f],e=0;e<a.numBones;e++)c=a.getBone(e),b[e].position.set(c.start.x,c.start.y,0),b[e].lookAt(d.set(c.end.x,c.end.y,0))},setFixedBaseMode:function(a){this.fixedBaseMode=a;a=this.numChains;for(var b;a--;)b=this.chains[a].getConnectedChainNumber(),
-1===b&&this.chains[a].setFixedBaseMode(this.fixedBaseMode)},clear:function(){this.clearAllBoneMesh();var a;for(a=this.numChains;a--;)this.remove(a);this.chains=[];this.meshChains=[];this.targets=[]},add:function(a,b,c){this.chains.push(a);this.targets.push(b);this.numChains++;c&&this.addChainMeshs(a)},remove:function(a){this.chains[a].clear();this.chains.splice(a,1);this.meshChains.splice(a,1);this.targets.splice(a,1);this.numChains--},getNumChains:function(){return this.numChains},getChain:function(a){return this.chains[a]},
connectChain:function(a,b,c,d,e,f,g){d=d||"end";if(b>this.numChains)q.error("Chain not existe !");else if(c>this.chains[b].numBones)q.error("Bone not existe !");else{a=a.clone();a.setBoneConnectionPoint("end"===d?21:20);a.setConnectedChainNumber(b);a.setConnectedBoneNumber(c);b="end"===d?this.chains[b].bones[c].end:this.chains[b].bones[c].start;a.setBaseLocation(b);a.setFixedBaseMode(!0);for(c=0;c<a.numBones;c++)a.bones[c].start.add(b),a.bones[c].end.add(b);this.add(a,e,f)}},addChainMeshs:function(a,
b){this.isWithMesh=!0;b=[];for(var c=a.bones.length,d=0;d<c;d++)b.push(this.addBoneMesh(a.bones[d]));this.meshChains.push(b)},addBoneMesh:function(a){var b=a.length,c=a.color;a=new THREE.CylinderBufferGeometry(1,.5,b,4);a.applyMatrix((new THREE.Matrix4).makeRotationX(-g.pi90));a.applyMatrix((new THREE.Matrix4).makeTranslation(0,0,.5*b));b=new THREE.MeshStandardMaterial({color:c,wireframe:!1,shadowSide:!1});new THREE.MeshBasicMaterial({wireframe:!0});b=new THREE.Mesh(a,b);b.castShadow=!0;b.receiveShadow=
!0;this.scene.add(b);return b},clearAllBoneMesh:function(){if(this.isWithMesh){var a,b;for(a=this.meshChains.length;a--;){for(b=this.meshChains[a].length;b--;){var c=this.meshChains[a][b];this.scene.remove(c);c.geometry.dispose();c.material.dispose()}this.meshChains[a]=[]}this.meshChains=[]}}});Object.assign(B.prototype,{isIKSolver:!0});f._Math=g;f.V2=n;f.V3=h;f.M3=t;f.Joint3D=u;f.Bone3D=r;f.Chain3D=x;f.Structure3D=z;f.Joint2D=v;f.Bone2D=w;f.Chain2D=y;f.Structure2D=A;f.IKSolver=B;f.REVISION="1.3.3";
f.MIN_DEGS=0;f.MAX_DEGS=180;f.PRECISION=.001;f.PRECISION_DEG=.01;f.MAX_VALUE=Infinity;f.NONE=1;f.GLOBAL_ROTOR=2;f.GLOBAL_HINGE=3;f.LOCAL_ROTOR=4;f.LOCAL_HINGE=5;f.GLOBAL_ABSOLUTE=6;f.LOCAL_RELATIVE=7;f.LOCAL_ABSOLUTE=8;f.J_BALL=10;f.J_LOCAL=11;f.J_GLOBAL=12;f.START=20;f.END=21;f.X_AXE=D;f.Y_AXE=E;f.Z_AXE=F;f.X_NEG=G;f.Y_NEG=H;f.Z_NEG=I;f.UP=C;f.DOWN=J;f.LEFT=K;f.RIGHT=L;Object.defineProperty(f,"__esModule",{value:!0})});
