...
Fullik.rotateAboutAxisRads=function(a,b,c){var d=new Fullik.M3,e=Math.sin(b);b=Math.cos(b);var f=1-b,k=c.x*c.y*f,g=c.x*c.z*f,l=c.y*c.z*f,h=d.elements;h[0]=c.x*c.x*f+b;h[3]=k+c.z*e;h[6]=g-c.y*e;h[1]=k-c.z*e;h[4]=c.y*c.y*f+b;h[7]=l+c.x*e;h[2]=g+c.y*e;h[5]=l-c.x*e;h[8]=c.z*c.z*f+b;return d.timesV3(a)};Fullik.rotateXDegs=function(a,b){return Fullik.rotateXRads(a,b*Fullik.torad)};Fullik.rotateYDegs=function(a,b){return Fullik.rotateYRads(a,b*Fullik.torad)};
...
Fullik.M3.prototype.setV3=function(a,b,c){var d=this.elements;d[0]=a.x;d[1]=b.x;d[2]=c.x;d[3]=a.y;d[4]=b.y;d[5]=c.y;d[6]=a.z;d[7]=b.z;d[8]=c.z;return this};Fullik.M3.prototype.timesV3=function(a){var b=this.elements;return new Fullik.V3(b[0]*a.x+b[1]*a.y+b[2]*a.z,b[3]*a.x+b[4]*a.y+b[5]*a.z,b[6]*a.x+b[7]*a.y+b[8]*a.z)};
...
Fullik.Joint.prototype={constructor:Fullik.Joint,clone:function(){return new Fullik.Joint(this)},setAsBallJoint:function(a){this.mRotorConstraintDegs=a;this.type=Fullik.J_BALL},setHinge:function(a,b,c,d,e){this.type=a;this.mHingeClockwiseConstraintDegs=c;this.mHingeAnticlockwiseConstraintDegs=d;this.mRotationAxisUV.copy(b.normalised());this.mReferenceAxisUV.copy(e.normalised())},getJointType:function(){return this.type},getHingeClockwiseConstraintDegs:function(){if(this.type!==Fullik.J_BALL)return this.mHingeClockwiseConstraintDegs},
...
e>d&&(g=Fullik.getAngleLimitedUnitVectorDegs(g,k,d))):e===Fullik.J_GLOBAL_HINGE?(h=d.getHingeRotationAxis(),g=g.projectOnPlane(h).normalize(),e=-d.getHingeClockwiseConstraintDegs(),k=d.getHingeAnticlockwiseConstraintDegs(),Fullik.nearEquals(e,-Fullik.MAX_ANGLE_DEGS,Fullik.PRECISION)||Fullik.nearEquals(k,Fullik.MAX_ANGLE_DEGS,Fullik.PRECISION)||(l=d.getHingeReferenceAxis(),d=Fullik.getSignedAngleBetweenDegs(l,g,h),d>k?g=Fullik.rotateAboutAxisDegs(l,k,h).normalised():d<e&&(g=Fullik.rotateAboutAxisDegs(l,
e,h).normalised()))):e===Fullik.J_LOCAL_HINGE&&(h=d.getHingeRotationAxis(),l=Fullik.createRotationMatrix(k),h=l.timesV3(h).normalize(),g=g.projectOnPlane(h).normalize(),e=-d.getHingeClockwiseConstraintDegs(),k=d.getHingeAnticlockwiseConstraintDegs(),Fullik.nearEquals(e,-Fullik.MAX_ANGLE_DEGS,Fullik.PRECISION)||Fullik.nearEquals(k,Fullik.MAX_ANGLE_DEGS,Fullik.PRECISION)||(l=l.timesV3(d.getHingeReferenceAxis()).normalize(),d=Fullik.getSignedAngleBetweenDegs(l,g,h),d>k?g=Fullik.rotateAboutAxisDegs(l,
k,h).normalize():d<e&&(g=Fullik.rotateAboutAxisDegs(l,e,h).normalize()))),c=b.getStartLocation().plus(g.times(c)),b.setEndLocation(c),f<this.mNumBones-1&&this.bones[f+1].setStartLocation(c)):(this.mFixedBaseMode?b.setStartLocation(this.mFixedBaseLocation):b.setStartLocation(b.getEndLocation().minus(b.getDirectionUV().times(c))),this.mBaseboneConstraintType===Fullik.BB_NONE?(c=b.getStartLocation().plus(b.getDirectionUV().times(c)),b.setEndLocation(c),1<this.mNumBones&&this.bones[1].setStartLocation(c)):
this.mBaseboneConstraintType===Fullik.BB_GLOBAL_ROTOR?(g=b.getDirectionUV(),e=Fullik.getAngleBetweenDegs(this.mBaseboneConstraintUV,g),d=b.getBallJointConstraintDegs(),e>d&&(g=Fullik.getAngleLimitedUnitVectorDegs(g,this.mBaseboneConstraintUV,d)),c=b.getStartLocation().plus(g.times(c)),b.setEndLocation(c),1<this.mNumBones&&this.bones[1].setStartLocation(c)):this.mBaseboneConstraintType===Fullik.BB_LOCAL_ROTOR?(g=b.getDirectionUV(),e=Fullik.getAngleBetweenDegs(this.mBaseboneRelativeConstraintUV,g),
d=b.getBallJointConstraintDegs(),e>d&&(g=Fullik.getAngleLimitedUnitVectorDegs(g,this.mBaseboneRelativeConstraintUV,d)),c=b.getStartLocation().plus(g.times(c)),b.setEndLocation(c),1<this.mNumBones&&this.bones[1].setStartLocation(c)):this.mBaseboneConstraintType===Fullik.BB_GLOBAL_HINGE?(d=b.getJoint(),h=d.getHingeRotationAxis(),e=-d.getHingeClockwiseConstraintDegs(),k=d.getHingeAnticlockwiseConstraintDegs(),g=b.getDirectionUV().projectOnPlane(h).normalize(),Fullik.nearEquals(e,Fullik.MAX_ANGLE_DEGS,
Fullik.PRECISION_DEG)||Fullik.nearEquals(k,Fullik.MAX_ANGLE_DEGS,Fullik.PRECISION_DEG)||(l=d.getHingeReferenceAxis(),d=Fullik.getSignedAngleBetweenDegs(l,g,h),d>k?g=Fullik.rotateAboutAxisDegs(l,k,h).normalize():d<e&&(g=Fullik.rotateAboutAxisDegs(l,e,h).normalize())),c=b.getStartLocation().plus(g.times(c)),b.setEndLocation(c),1<this.mNumBones&&this.bones[1].setStartLocation(c)):this.mBaseboneConstraintType===Fullik.BB_LOCAL_HINGE&&(d=b.getJoint(),h=this.mBaseboneRelativeConstraintUV,e=-d.getHingeClockwiseConstraintDegs(),
k=d.getHingeAnticlockwiseConstraintDegs(),g=b.getDirectionUV().projectOnPlane(h).normalize(),Fullik.nearEquals(e,Fullik.MAX_ANGLE_DEGS,Fullik.PRECISION_DEG)||Fullik.nearEquals(k,Fullik.MAX_ANGLE_DEGS,Fullik.PRECISION_DEG)||(l=this.mBaseboneRelativeReferenceConstraintUV,d=Fullik.getSignedAngleBetweenDegs(l,g,h),d>k?g=Fullik.rotateAboutAxisDegs(l,k,h).normalize():d<e&&(g=Fullik.rotateAboutAxisDegs(l,e,h).normalize())),c=b.getStartLocation().plus(g.times(c)),b.setEndLocation(c),1<this.mNumBones&&this.bones[1].setStartLocation(c)));
this.mLastTargetLocation.copy(a);return Fullik.distanceBetween(this.bones[this.mNumBones-1].getEndLocation(),a)}},updateChainLength:function(){this.bonesLength=0;for(var a=this.mNumBones;a--;)this.bonesLength+=this.bones[a].getLength()},cloneIkChain:function(){for(var a=this.bones.length,b=[],c=0;c<a;c++)b.push(this.bones[c].clone());return b}};Fullik.Structure=function(){this.chains=[];this.meshChains=[];this.targets=[];this.mNumChains=0};
